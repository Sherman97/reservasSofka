...
-- CRITICAL: This composite index is essential for ReservationMonitorJob performance
-- Without it, the job would scan the entire reservations table every minute

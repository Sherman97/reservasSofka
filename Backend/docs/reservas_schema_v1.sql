...
-- ============================================================
-- RESERVATION_HANDOVER_LOGS (bitacora de entrega/devolucion)
-- ============================================================
CREATE TABLE reservation_handover_logs (
  id BIGINT AUTO_INCREMENT PRIMARY KEY,
  reservation_id INT NOT NULL,
  space_id INT NOT NULL,
  user_id INT NOT NULL,      -- quien realizo la reserva
  staff_id INT NOT NULL,     -- encargado que recibe/entrega
  action VARCHAR(30) NOT NULL, -- DELIVERED / RETURNED
  novelty TEXT NULL,
